    ...
    <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-gray-500 rounded-r-lg my-5" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-brown1">
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="dashboard-author" class="flex items-center p-2 text-white rounded-lg bg-gray-700 hover:bg-gray-400 group">
                ...
                <li>
                    <a href="bookmark-author" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-400 group">
                ...
                <li>
                    <a href="history-author" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-400 group">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="27" viewBox="0 0 30 27" fill="none">
                ...
                <li>
                    <a href="tulis-author" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-400 group">
                ...
                <li>
                    <a href="#" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-400 group">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="27" viewBox="0 0 30 27" fill="none">
                ...
                <div class="mt-[100px]">
                    <div class="flex flex-col text-black-50 mt-5">
                        <div class="flex flex-row">
                            ...
                            <a href="">/</a>
                            <a href="#" class="text-black underline"> Novel terbaru</a>
                        </div>
                    ...
                    {{-- Card start --}}
                    <div class="relative flex flex-row items-center justify-center h-48 mb-4 mt-[300px] gap-x-4">
                        <div class="relative bottom-[350px] left-[200px] flex flex-row gap-x-5">
                            <a href="halamanbaca-author">
                        ...
                        <a href="#" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow mt-2 mb-2 md:flex-row md:max-w-xl hover:bg-gray-100">
                            <img class="absolute -top-[250px] left-[115px] object-cover w-full rounded-lg h-96 p-3 md:h-auto md:w-[300px] md:rounded-none md:rounded-s-lg z-10" src="{{ asset('img/download .jpeg') }}" alt="">
                            <div class="absolute -bottom-[25px] left-[100px] bg-white shadow border border-lg rounded flex flex-col justify-between p-4 leading-normal w-[1200px] h-[400px] z-0">
                                ...
                                <h5 class="mt-7 ms-[310px] text-2xl font-bold tracking-tight text-gray-900">Harry Potter and the Sourcerers Stone</h5>
                                <p class="mt-2 ms-[310px] font-normal text-gray-700">Author: J. K. Rowling</p>
                                <h5 class="mt-3 ms-[310px] font-normal text-gray-700">Sinopsis:</h5>
                                <p class="mb-3 ms-[310px] font-normal text-gray-700">Harry Potter, seorang anak yatim piatu yang hidup dalam kondisi menyedihkan bersama bibi, paman, dan sepupunya yang acuh tak acuh, menemukan kehidupan yang sama sekali berbeda pada hari ulang tahunnya yang kesebelas. Pada hari yang istimewa tersebut, Harry menerima surat undangan misterius yang menyatakan bahwa ia memiliki kekuatan sihir dan telah diterima di Sekolah Sihir Hogwarts yang terkenal.</p>
