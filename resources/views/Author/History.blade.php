...
<body class="bg-sky-100">
    ...
    <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-sky-500 rounded-r-lg my-5" aria-label="Sidebar">
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="history-author" class="flex items-center p-2 text-white rounded-lg bg-sky-700 group">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="27" viewBox="0 0 30 27" fill="none">
                ...
                <div class="fixed flex flex-row gap-4 mb-4 w-full rounded bg-sky-100 px-4">
                    ...
                    <div class="absolute right-[30px] mt-[90px] bg-sky-100 w-full">
                        <div class="flex flex-col text-black-50 mt-5 ml-[50px]">
                            <button type="button" class="py-3 px-5 me-2 mb-2 text-sm font-medium text-white focus:outline-none bg-sky-700 rounded-full border border-gray-200 w-[150px] focus:z-10 focus:ring-4 focus:ring-gray-200">Last History</button>
                        </div>
                ...
                <div class="z-0 ">
                    <div class="relative flex flex-row mt-[250px] p-3 border border-gray-50 border-lg shadow rounded w-1/2 bg-white">
                        ...
                        <div class="absolute top-[80px] left-[530px]">
                            <button type="button" class="focus:outline-none text-white bg-sky-700 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-[50px] py-2.5 me-2 mb-2">Publish</button>
                        </div>
                    </div>
                    <div class="relative flex flex-row mt-5 p-3 border border-gray-50 border-lg shadow rounded w-1/2 bg-white">
                        ...
                        <div class="absolute top-[80px] left-[530px]">
                            <button type="button" class="focus:outline-none text-white bg-sky-700 hover:bg-green-500 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-[50px] py-2.5 me-2 mb-2">Publish</button>
                        </div>
                    </div>
                    <div class="relative flex flex-row mt-5 p-3 border border-gray-50 border-lg shadow rounded w-1/2 bg-white">
                        <div class="">
