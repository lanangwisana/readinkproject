                ...
                <div class="relative flex flex-row">
                    ...
                    <div class=" absolute top-[0px] left-[300px] w-[900px] p-5 border border-lg bg-white rounded shadow">
                        ...
                        <div class="mb-6 mt-7">
                            ...
                            <input type="text" id="default-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Masukkan Judul">
                        </div>
                        <form class="mt-6">
                        ...
                        <div class="flex flex-row gap-x-5 justify-end">
                            ...
                            <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 focus:outline-none"><a href="tuliscerita-author">Selanjutnya</a></button>
                        </div>
                    </div>
                    </div>
                    </div>
