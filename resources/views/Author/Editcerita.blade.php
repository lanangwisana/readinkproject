        ...
        <div class="relative">
            ...
            <div>
                ...
                <div class="relative flex flex-col">
                    <div class=" absolute top-[0px] -left-[10px] w-[1200px] p-5 border border-lg bg-white rounded shadow">
                        <p class="font-bold text-lg text-center">Detail Cerita</p>
                        <img class="justify-center w-[auto] h-[50px] mt-10 mb-5 absolute top-[30px] left-[350px]" src="{{ asset('img/Group 83.png') }}" alt="">
                        <form class="mt-[100px]">
                        ...
                        <div class="flex flex-row gap-x-5 justify-end">
                            <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 focus:outline-none"><a href="addcerita-author"><a href="tulis-author">Batalkan</a></a></button>
                            <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 focus:outline-none">Publish</button>
                        </div>
                    </div>
                    </div>
                    </div>
