...
<body class="bg-sky-100">
    ...
    <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-sky-500 rounded-r-lg my-5" aria-label="Sidebar">
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="bookmark-author" class="flex items-center p-2 text-white rounded-lg bg-sky-700 group">
                            ...
                            <div class="fixed flex flex-col mt-[130px] px-4 w-full bg-sky-100">
                                <div class="flex flex-row gep-5 mt-5 mb-5">
                                    <a href="bookmark-author">
                                        <button type="button" class="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-200 focus:outline-none bg-sky-700 rounded-full border border-gray-200 focus:z-10 focus:ring-4 focus:ring-gray-200">Reading Lists</button>
                                    </a>
                                    <a href="favorit-author">
                                        <button type="button" class="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-sky-700 focus:outline-none rounded-full border border-gray-200 hover:bg-sky-700 hover:text-white focus:z-10 focus:ring-4 focus:ring-gray-200">Favorite</button>
                                    </a>
                                </div>
                            </div>
                            {{-- Navigasi Bookmark start --}}
                        ...
                        <div class=" mt-[100px]">
                            ...
                            <div class="flex flex-col">
                                <div class="flex flex-row gep-5 mt-5">
                                    <button type="button" class="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-300 focus:outline-none bg-blue-700 rounded-full border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200">Reading Lists</button>
                                    <button type="button" class="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-full border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200">Favorite</button>
                                </div>
                            </div> --}}
                            {{-- Navigasi Bookmark end --}}
                            <div class="flex flex-col mt-[200px]">
                                <div class="flex flex-row items-center justify-center h-48 mb-4 mt-10 gap-x-4">
                                    <a href="#" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow mt-2 mb-2 md:flex-row md:max-w-xl hover:bg-gray-100">
                                        ...
                                        <div class="flex flex-col p-4 leading-normal">
                                            <h5 class="mb-2 text-medium font-bold tracking-tight text-gray-900">Omniscient Reader Viewpoint</h5>
                                            <p class="mb-3 font-normal text-gray-700">Sing-Shong</p>
                                            <p class="mt-5 font-normal text-gray-700">1 hari yang lalu</p>
                                            <button type="button" class="py-2.5 px-5 me-2 mt-4 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-full border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200">Continue read</button>
                                        </div>
                                    </a>
                                    <a href="#" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow mt-2 mb-2 md:flex-row md:max-w-xl hover:bg-gray-100">
