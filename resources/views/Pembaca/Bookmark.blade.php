...
<body class="bg-sky-100">
    ...
    <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-sky-500 rounded-r-lg my-5" aria-label="Sidebar">
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="dashboard-pembaca" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-sky-400 dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href="bookmark-pembaca" class="flex items-center p-2 text-white rounded-lg bg-sky-700 dark:text-white dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href="histori-pembaca" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-sky-400 dark:hover:bg-gray-700 group">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="27" viewBox="0 0 30 27" fill="none">
