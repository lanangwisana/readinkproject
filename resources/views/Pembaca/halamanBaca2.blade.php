...
<body class="bg-gray-50">
    ...
    <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-gray-500 rounded-r-lg my-5" aria-label="Sidebar">
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="dashboard-pembaca" class="flex items-center p-2 text-white rounded-lg bg-gray-700 hover:bg-gray-400 group">
            ...
            <li>
                <a href="bookmark-pembaca" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-400 group">
            ...
            <li>
                <a href="history-pembaca" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-400 group">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="27" viewBox="0 0 30 27" fill="none">
            ...
            <li>
                <a href="setting-pembaca" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-400 group">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="27" viewBox="0 0 30 27" fill="none">
            ...
            <div>
                ...
                <div class="mt-[100px]">
                    ...
                    <div class="relative flex flex-row items-center justify-center h-48 mb-4 mt-[300px] gap-x-4">
                        ...
                        <a href="mulaibaca-author" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow mt-2 mb-2 md:flex-row md:max-w-xl hover:bg-gray-100">
