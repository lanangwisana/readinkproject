                            ...
                            <div class="fixed flex flex-col mt-[130px] px-4 w-full bg-sky-100">
                                <div class="flex flex-row gep-5 mt-5 mb-5">
                                    <a href="bookmark-pembaca">
                                        <button type="button" class="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-sky-700 focus:outline-none rounded-full border border-gray-200 hover:bg-sky-700 hover:text-white focus:z-10 focus:ring-4 focus:ring-gray-200">Reading Lists</button>
                                    </a>
                                    <a href="favorit-pembaca">
                                        <button type="button" class="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-white focus:outline-none rounded-full bg-sky-700 border border-gray-200 focus:z-10 focus:ring-4 focus:ring-gray-200">Favorite</button>
                                    </a>
                                </div>
                            </div>
                            {{-- Navigasi Bookmark start --}}
