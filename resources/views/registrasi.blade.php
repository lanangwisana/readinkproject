...
<body>
    <div class="flex flex-row">
        <div class="relative -left-32 top-32">
            <img src="{{ asset('img/ReadInk .png') }}" alt="">
        </div>
        <div class="relative top-[70px] -left-[100px] py-52 border border-lg rounded bg-gray-100 w-6/12 h-auto">
            <div class="flex flex-col">
                <p class="relative bottom-32 font-bold text-2xl ml-32 mb-50">Registrasi</p>
                <form class="max-w-xl mx-auto relative ml-32 bottom-28">
                    ...
                    <div class="relative z-0 w-full mb-5 group">
                        ...
                        <label for="floating_password" class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Password</label>
                    </div>
                    <div class="relative z-0 w-full mb-5 group">
                        ...
                        <label for="floating_repeat_password" class="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Confirm password</label>
                    </div>
                    ...
                    <div class="flex flex-row">
                        ...
                        <div class="flex flex-col ml-4 mb-5">
                            <div class="flex items-center mb-4">
                                ...
                                <label for="default-radio-1" class="ms-2 text-sm font-medium text-gray-900">Author</label>
                            </div>
                            <div class="flex items-center">
                                ...
                                <label for="default-radio-2" class="ms-2 text-sm font-medium text-gray-900">Pembaca</label>
                            </div>
                        </div>
                    </div>
