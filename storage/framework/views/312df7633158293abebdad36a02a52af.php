                ...
                <div class="relative flex flex-col">
                    <div class=" absolute top-[0px] -left-[10px] w-[1200px] p-5 border border-lg bg-white rounded shadow">
                        ...
                        <div class="flex flex-row gap-x-5 justify-end">
                            <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"><a href="addcerita-author">Batalkan</a></button>
...
</html><?php /**PATH C:\xampp\htdocs\TUBES IDAP & WEBPRO\readink\resources\views/Author/Tuliscerita.blade.php ENDPATH**/ ?>