...
<body class="bg-gray-50">
    ...
    <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-yellow-700 rounded-r-lg my-5" aria-label="Sidebar">
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="dashboard" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-yellow-900 dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href="bookmark" class="flex items-center p-2 text-white rounded-lg bg-yellow-800 dark:text-white hover:bg-yellow-900 dark:hover:bg-gray-700 group">
        ...
        <div class="p-4 sm:ml-64">
            <div class="relative">
                <div class="absolute -top-[220px] -left-4">
                        ...
                        <div class="flex flex-col">
                            <div class="fixed flex flex-row gap-4 mb-4 w-full rounded bg-gray-50 px-4">
                                ...
                                <button id="mega-menu-dropdown-button" data-dropdown-toggle="mega-menu-dropdown" class="flex items-center w-1/5 font-medium text-gray-600 rounded p-5 bg-gray-50">
                                ...
                                <div class="flex flex-row items-center justify-center item-end h-15  dark:bg-gray-800">
                            ...
                            <div class="fixed flex flex-col text-black-50 mt-[90px] px-4 w-full bg-gray-50">
                                <div class="flex flex-row justify-between">
                                    <h5 class="font-bold text-2xl text-black mt-3">Bookmark</h5>
                                </div>
                            </div>
                            <div class="fixed flex flex-col mt-[130px] px-4 w-full bg-gray-50">
...
</body><?php /**PATH C:\xampp\htdocs\TUBES IDAP & WEBPRO\readink\resources\views/Author/Readinglist.blade.php ENDPATH**/ ?>