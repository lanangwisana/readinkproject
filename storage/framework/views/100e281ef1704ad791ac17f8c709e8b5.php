...
<body class="bg-sky-100">
    ...
    <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-sky-500 rounded-r-lg my-5" aria-label="Sidebar">
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="dashboard-pembaca" class="flex items-center p-2 text-white rounded-lg bg-sky-700 dark:text-white dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href="history-pembaca" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-sky-400 dark:hover:bg-gray-700 group">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="27" viewBox="0 0 30 27" fill="none">
                ...
                <div class="mt-[100px]">
                    <div class="flex flex-col text-black-50 mt-5">
                        <div class="flex flex-row">
                            ...
                            <a href="">/</a>
                            <a href="halamanbaca-pembaca" class="text-black underline"> Novel terbaru</a>
                        </div>
                    ...
                    <div class="relative flex flex-row items-center justify-center h-48 mb-4 mt-[300px] gap-x-4 dark:bg-gray-800">
                        ...
                        <a href="mulaibaca-pembaca" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow mt-2 mb-2 md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                            <img class="absolute -top-[250px] left-[115px] object-cover w-full rounded-lg h-96 p-3 md:h-auto md:w-[300px] md:rounded-none md:rounded-s-lg z-10" src="<?php echo e(asset('img/download (2).jpeg')); ?>" alt="">
...
</html><?php /**PATH C:\xampp\htdocs\TUBES IDAP & WEBPRO\readink\resources\views/Pembaca/halamanBaca.blade.php ENDPATH**/ ?>