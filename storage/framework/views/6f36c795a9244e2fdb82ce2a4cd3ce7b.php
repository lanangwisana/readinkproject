                ...
                <div class="mt-[100px]">
                    <div class="flex flex-col text-black-50 mt-5">
                        <div class="flex flex-row">
                            ...
                            <a href="">/</a>
                            <a href="halamanBaca-pembaca" class="text-black"> Novel terbaru</a>
                            <a href="">/</a>
                            <a href="mulaiBaca-pembaca" class="text-black underline"> Mulai Baca</a>
                        </div>
                    </div>
                    
                    <div class="flex flex-row relative bottom-[130px]">
                        <img class="relative top-12 left-[180px] w-[1000px] h-auto" src="<?php echo e(asset('img/BUKU.png')); ?>" alt="">
                        ...
                        <img class="w-[180px] h-[300px] relative top-[180px] right-[1000px]" src="<?php echo e(asset('img/download (2).jpeg')); ?>" alt="">
                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\TUBES IDAP & WEBPRO\readink\resources\views/Pembaca/mulaiBaca.blade.php ENDPATH**/ ?>