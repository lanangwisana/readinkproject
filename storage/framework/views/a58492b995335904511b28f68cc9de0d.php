...
<body class="bg-sky-100">
    ...
    <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-sky-500 rounded-r-lg my-5" aria-label="Sidebar">
        ...
        <ul class="space-y-2 font-medium">
            <li>
                <a href="#" class="flex justify-center text-gray-900 rounded-lg  dark:text-white dark:hover:bg-gray-700 group">
                    <img src="<?php echo e(asset('img/ReadInk .png')); ?>" alt="logo readink">
                </a>
            </li>
            <li>
                <a href="dashboard-author" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-sky-400 dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href="bookmark-author" class="flex items-center p-2 text-white rounded-lg bg-sky-700 dark:text-white dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href="tulis-author" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-sky-400 dark:hover:bg-gray-400 group">
        ...
        <div class="p-4 sm:ml-64">
            <div class="relative">
                <div class="absolute -top-[217px] -left-4">
                        ...
                        <div class="flex flex-col">
                            <div class="fixed flex flex-row gap-4 mb-4 w-full rounded bg-sky-100 px-4">
                                ...
                                <button id="mega-menu-dropdown-button" data-dropdown-toggle="mega-menu-dropdown" class="flex items-center w-1/5 font-medium text-gray-600 rounded p-5 bg-sky-100">
                            ...
                            <div class="fixed flex flex-col text-black-50 mt-[90px] px-4 w-full bg-sky-100">
                                <div class="flex flex-row justify-between">
                                    <h5 class="font-bold text-2xl text-black mt-3">Bookmark</h5>
                                </div>
                            </div>
                            <div class="fixed flex flex-col mt-[130px] px-4 w-full bg-sky-100">
                                <div class="flex flex-row gep-5 mt-5 mb-5">
                                    <a href="bookmark-author">
                                        <button type="button" class="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-200 focus:outline-none bg-sky-700 rounded-full border border-gray-200 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Reading Lists</button>
                                    </a>
                                    <a href="favorit-author">
                                        <button type="button" class="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-sky-700 focus:outline-none rounded-full border border-gray-200 hover:bg-sky-700 hover:text-white focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Favorite</button>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="">
                        <div class=" mt-[100px]">
                            ...
                            <div class="flex flex-col mt-[200px]">
                                <div class="flex flex-row items-center justify-center h-48 mb-4 mt-10 gap-x-4 dark:bg-gray-800">
                                    <a href="#" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow mt-2 mb-2 md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                                        <img class="object-cover w-full rounded-t-lg h-96 p-3 md:h-auto md:w-40 md:rounded-none md:rounded-s-lg" src="<?php echo e(asset('img/23 science fiction and fantasy book covers that are out of this world - 99designs.jpeg')); ?>" alt="">
                                        <div class="flex flex-col p-4 leading-normal">
                                            <h5 class="mb-2 text-medium font-bold tracking-tight text-gray-900 dark:text-white">Omniscient Reader Viewpoint</h5>
                                            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Sing-Shong</p>
                                            <p class="mt-5 font-normal text-gray-700 dark:text-gray-400">1 hari yang lalu</p>
                                            <button type="button" class="py-2.5 px-5 me-2 mt-4 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-full border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Continue read</button>
                                        </div>
                                    </a>
                                    <a href="#" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow mt-2 mb-2 md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                                        <img class="object-cover w-full rounded-t-lg h-96 p-3 md:h-auto md:w-40 md:rounded-none md:rounded-s-lg" src="<?php echo e(asset('img/Sung Jinwoo☆ 1.png')); ?>" alt="">
                                        <div class="flex flex-col p-4 leading-normal">
                                            <h5 class="mb-2 text-medium font-bold tracking-tight text-gray-900 dark:text-white">Omniscient Reader Viewpoint</h5>
                                            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Sing-Shong</p>
                                            <p class="mt-5 font-normal text-gray-700 dark:text-gray-400">1 hari yang lalu</p>
                                    ...
                                    <a href="#" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow mt-2 mb-2 md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                                        <img class="object-cover w-full rounded-t-lg h-96 p-3 md:h-auto md:w-40 md:rounded-none md:rounded-s-lg" src="<?php echo e(asset('img/Book cover - ABRA CADABRA by MirellaSantana on DeviantArt.jpeg')); ?>" alt="">
                                        <div class="flex flex-col p-4 leading-normal">
                                            <h5 class="mb-2 text-medium font-bold tracking-tight text-gray-900 dark:text-white">Omniscient Reader Viewpoint</h5>
                                            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Sing-Shong</p>
                                            <p class="mt-5 font-normal text-gray-700 dark:text-gray-400">1 hari yang lalu</p>
                                    ...
                                    <a href="#" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow mt-2 mb-2 md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                                        <img class="object-cover w-full rounded-t-lg h-96 p-3 md:h-auto md:w-40 md:rounded-none md:rounded-s-lg" src="<?php echo e(asset('img/kimgongja 1.png')); ?>" alt="">
                                        <div class="flex flex-col p-4 leading-normal">
                                            <h5 class="mb-2 text-medium font-bold tracking-tight text-gray-900 dark:text-white">Omniscient Reader Viewpoint</h5>
                                            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Sing-Shong</p>
                                            <p class="mt-5 font-normal text-gray-700 dark:text-gray-400">1 hari yang lalu</p>
                                ...
                                <div class="flex flex-row items-center justify-center h-48 mb-4 mt-10 gap-x-4 dark:bg-gray-800">
                                    <a href="#" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow mt-2 mb-2 md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                                        <img class="object-cover w-full rounded-t-lg h-96 p-3 md:h-auto md:w-40 md:rounded-none md:rounded-s-lg" src="<?php echo e(asset('img/FANTASY ROMANCE BOOK COVER DESIGN by DAVID GARDIAS.jpeg')); ?>" alt="">
                                        <div class="flex flex-col p-4 leading-normal">
                                            <h5 class="mb-2 text-medium font-bold tracking-tight text-gray-900 dark:text-white">Omniscient Reader Viewpoint</h5>
                                            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Sing-Shong</p>
                                            <p class="mt-5 font-normal text-gray-700 dark:text-gray-400">1 hari yang lalu</p>
                                    ...
                                    <a href="#" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow mt-2 mb-2 md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                                        <img class="object-cover w-full rounded-t-lg h-96 p-3 md:h-auto md:w-40 md:rounded-none md:rounded-s-lg" src="<?php echo e(asset('img/The most popular epub book covers for kids.jpeg')); ?>" alt="">
                                        <div class="flex flex-col p-4 leading-normal">
                                            <h5 class="mb-2 text-medium font-bold tracking-tight text-gray-900 dark:text-white">Omniscient Reader Viewpoint</h5>
                                            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Sing-Shong</p>
                                            <p class="mt-5 font-normal text-gray-700 dark:text-gray-400">1 hari yang lalu</p>
                                    ...
                                    <a href="#" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow mt-2 mb-2 md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                                        <img class="object-cover w-full rounded-t-lg h-96 p-3 md:h-auto md:w-40 md:rounded-none md:rounded-s-lg" src="<?php echo e(asset('img/The Secret Dragon.jpeg')); ?>" alt="">
                                        <div class="flex flex-col p-4 leading-normal">
                                            <h5 class="mb-2 text-medium font-bold tracking-tight text-gray-900 dark:text-white">Omniscient Reader Viewpoint</h5>
                                            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Sing-Shong</p>
                                            <p class="mt-5 font-normal text-gray-700 dark:text-gray-400">1 hari yang lalu</p>
                                    ...
                                    <a href="#" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow mt-2 mb-2 md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                                        <img class="object-cover w-full rounded-t-lg h-96 p-3 md:h-auto md:w-40 md:rounded-none md:rounded-s-lg" src="<?php echo e(asset('img/kimdokja 1.png')); ?>" alt="">
                                        <div class="flex flex-col p-4 leading-normal">
                                            <h5 class="mb-2 text-medium font-bold tracking-tight text-gray-900 dark:text-white">Omniscient Reader Viewpoint</h5>
                                            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Sing-Shong</p>
                                            <p class="mt-5 font-normal text-gray-700 dark:text-gray-400">1 hari yang lalu</p>
                                ...
                                <div class="flex flex-row items-center justify-center h-48 mb-4 mt-10 gap-x-4 dark:bg-gray-800">
                                    <a href="#" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow mt-2 mb-2 md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                                        <img class="object-cover w-full rounded-t-lg h-96 p-3 md:h-auto md:w-40 md:rounded-none md:rounded-s-lg" src="<?php echo e(asset('img/DANADYAKSA - Indonesian Culture Manipulation Photo Editing Poster.jpeg')); ?>" alt="">
                                        <div class="flex flex-col p-4 leading-normal">
                                            <h5 class="mb-2 text-medium font-bold tracking-tight text-gray-900 dark:text-white">Omniscient Reader Viewpoint</h5>
                                            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Sing-Shong</p>
                                            <p class="mt-5 font-normal text-gray-700 dark:text-gray-400">1 hari yang lalu</p>
                                    ...
                                    <a href="#" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow mt-2 mb-2 md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                                        <img class="object-cover w-full rounded-t-lg h-96 p-3 md:h-auto md:w-40 md:rounded-none md:rounded-s-lg" src="<?php echo e(asset('img/The Ship of Cloud and Stars.jpeg')); ?>" alt="">
                                        <div class="flex flex-col p-4 leading-normal">
                                            <h5 class="mb-2 text-medium font-bold tracking-tight text-gray-900 dark:text-white">Omniscient Reader Viewpoint</h5>
                                            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Sing-Shong</p>
                                            <p class="mt-5 font-normal text-gray-700 dark:text-gray-400">1 hari yang lalu</p>
                                    ...
                                    <a href="#" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow mt-2 mb-2 md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                                        <img class="object-cover w-full rounded-t-lg h-96 p-3 md:h-auto md:w-40 md:rounded-none md:rounded-s-lg" src="<?php echo e(asset('img/You left me in the Dark (cyan version), Available PREMADE.jpeg')); ?>" alt="">
                                        <div class="flex flex-col p-4 leading-normal">
                                            <h5 class="mb-2 text-medium font-bold tracking-tight text-gray-900 dark:text-white">Omniscient Reader Viewpoint</h5>
                                            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Sing-Shong</p>
                                            <p class="mt-5 font-normal text-gray-700 dark:text-gray-400">1 hari yang lalu</p>
...
</body><?php /**PATH C:\xampp\htdocs\TUBES IDAP & WEBPRO\readink\resources\views/Author/Bookmark.blade.php ENDPATH**/ ?>