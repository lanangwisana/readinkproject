    ...
    <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-gray-500 rounded-r-lg my-5" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-brown1 dark:bg-gray-800">
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="dashboard-author" class="flex items-center p-2 text-white rounded-lg bg-gray-700 dark:text-white hover:bg-gray-400 dark:hover:bg-gray-700 group">
                ...
                <li>
                    <a href="bookmark-author" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-400 dark:hover:bg-gray-700 group">
                ...
                <li>
                    <a href="history-author" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-400 dark:hover:bg-gray-700 group">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="27" viewBox="0 0 30 27" fill="none">
                ...
                <li>
                    <a href="tulis-author" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-400 dark:hover:bg-gray-700 group">
                ...
                <li>
                    <a href="#" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-400 dark:hover:bg-gray-700 group">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="27" viewBox="0 0 30 27" fill="none">
                    ...
                    <div class="relative flex flex-row items-center justify-center h-48 mb-4 mt-[300px] gap-x-4 dark:bg-gray-800">
                        <div class="relative bottom-[350px] left-[200px] flex flex-row gap-x-5">
                            <a href="halamanbaca-author">
                                <img class="h-20 w-auto" src="<?php echo e(asset('img/Group 36.png')); ?>" alt="">
                            </a>
                            <img class="relative top-[35px] h-2 w-auto" src="<?php echo e(asset('img/Group 58.png')); ?>" alt="">
                            <a href="halamanbaca2-author">
                                <img class="h-20 w-auto" src="<?php echo e(asset('img/Group 35-frame.png')); ?>" alt="">
                            </a>
                        </div>
                        <a href="#" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow mt-2 mb-2 md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                            <img class="absolute -top-[250px] left-[115px] object-cover w-full rounded-lg h-96 p-3 md:h-auto md:w-[300px] md:rounded-none md:rounded-s-lg z-10" src="<?php echo e(asset('img/download .jpeg')); ?>" alt="">
...
</html><?php /**PATH C:\xampp\htdocs\TUBES IDAP & WEBPRO\readink\resources\views/Author/halamanBaca2.blade.php ENDPATH**/ ?>