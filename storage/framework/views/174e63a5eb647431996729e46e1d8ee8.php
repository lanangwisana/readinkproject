...
<body class="bg-gray-50">
    ...
    <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-yellow-700 rounded-r-lg my-5" aria-label="Sidebar">
        ...
        <ul class="space-y-2 font-medium">
            <li>
                <a href="#" class="flex justify-center text-gray-900 rounded-lg bg- dark:text-white dark:hover:bg-gray-700 group">
                    <img src="<?php echo e(asset('img/ReadInk .png')); ?>" alt="logo readink">
                </a>
            </li>
            <li>
                <a href="#" class="flex items-center p-2 text-white rounded-lg bg-yellow-800 dark:text-white hover:bg-yellow-900 dark:hover:bg-gray-700 group">
        ...
        <div class="absolute -top-[117px] -left-4">
            ...
            <div>
                ...
                <div class="mt-[100px]">
                    ...
                    <div class="flex flex-row items-center justify-center h-48 mb-4 mt-24 gap-x-4 dark:bg-gray-800">
                        ...
                        <a href="#" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow mt-2 mb-2 md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                            <img class="object-cover w-full rounded-t-lg h-96 p-3 md:h-auto md:w-48 md:rounded-none md:rounded-s-lg" src="<?php echo e(asset('img/download .jpeg')); ?>" alt="">
                            <div class="flex flex-col justify-between p-4 leading-normal">
                                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Harry Potter and the Sourcerers Stone</h5>
                                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Author: J. K. Rowling</p>
                                <p class="mt-5 font-normal text-gray-700 dark:text-gray-400">Genre: Fiksi</p>
...
</html><?php /**PATH C:\xampp\htdocs\TUBES IDAP & WEBPRO\readink\resources\views/index.blade.php ENDPATH**/ ?>