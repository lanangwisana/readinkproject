    ...
    <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-sky-500 rounded-r-lg my-5" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-brown1 dark:bg-gray-800">
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="tulis-author" class="flex items-center p-2 text-white rounded-lg bg-sky-700 dark:text-white dark:hover:bg-gray-700 group">
                ...
                <div class="fixed flex flex-row gap-4 mb-4 w-full rounded bg-sky-100 px-4">
                    ...
                    <div class="absolute right-[30px] mt-[90px] bg-sky-100 w-full">
                        ...
                        <div class="flex flex-row">
                            ...
                            <button type="button" class="absolute top-[10px] left-[700px] py-2 px-[50px] me-2 mb-2 text-sm font-medium text-white    focus:outline-none bg-sky-700 rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"><a href="addcerita-author">+Tulis</a></button>
                        </div>
                    </div>
                ...
                <div class="z-0">
                    <div class="relative flex flex-row mt-[250px] p-3 border border-gray-50 border-lg shadow rounded w-1/2">
                        ...
                        <div class="absolute top-[80px] left-[550px] flex flex-row">
                            <button type="button" class="focus:outline-none text-white bg-sky-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-xl px-[50px] py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"><a href="editcerita-author">Edit</a></button>
                            <a href="">
...
</html><?php /**PATH C:\xampp\htdocs\TUBES IDAP & WEBPRO\readink\resources\views/Author/Tulis.blade.php ENDPATH**/ ?>